            ...
            {[
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`bg-white/[0.08] backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/30 transition-all duration-300 group relative ${selectedCategory === category.category ? 'ring-2 ring-orange-500 shadow-lg shadow-orange-500/30' : ''
                    }`}
                >
                  {/* Dish count badge */}
                  {dishCount > 0 && (
            ...
            >
              {(['all', 'trending', 'nearby'] as const).map(filter => (
                <motion.button
                  ...
                  className={`px-6 py-3 rounded-2xl font-semibold capitalize transition-all duration-300 ${activeFilter === filter
                    ...
                    <div className="bg-white/[0.08] backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 hover:border-orange-500/50 hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-500 cursor-pointer h-full flex flex-col">
                      ...
                      <div className="relative h-56 overflow-hidden">
                        ...
                        >
                          <Heart
                            size={20}
                            className={`transition-colors ${favorites.includes(canteen._id)
